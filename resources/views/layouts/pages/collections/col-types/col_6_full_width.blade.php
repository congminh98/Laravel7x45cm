<div id="shopify-section-collection-fullwidth-6-template" class="shopify-section" style="display: {{Request('type') =='shop-6-col-full-width' ? 'block':'none'}}">
    <div class="collection-inner collection-fullwidth collection-fullwidth-6">
        <div class="collection-wrapper">
            ...
            <div id="collection">
                <div class="collection-content">
                    ...
                    @includeIf('layouts.partials.sidebar', ['filter' => 'true','type' => ''])
                    ...
                    <div class="collection-mainarea  col-sm-12 clearfix">
                                        ...
                                        <div class="product-pagination">
                                            <div class="pagination_group">
                                                <ul class="pagination pagination-collection">
                                                    ...
                                                    <li><a href="/collections/shop-6-col-full-width?page=2&sort_by=manual">2</a></li>
                                                    <li><a href="/collections/shop-6-col-full-width?page=3&sort_by=manual">3</a></li>
                                                    <li><a href="/collections/shop-6-col-full-width?page=4&sort_by=manual">4</a></li>
                                                    <li class="next"><a href="/collections/shop-6-col-full-width?page=2&sort_by=manual"><span>Next</span><i
                                    ...
                                    <div class="sortBy">
                                        ...
                                        <div class="sortBox control-container dropdown-menu">
                                            <ul class="sortForm list-unstyled option-set text-left list-styled" data-option-key="sortBy">
                                                <li class="sort manual"><a href="/collections/shop-6-col-full-width/?sort_by=manual">Featured</a></li>
                                                <li class="sort price-ascending"><a href="/collections/shop-6-col-full-width/?sort_by=price-ascending">Price, low to high</a></li>
                                                <li class="sort price-descending"><a href="/collections/shop-6-col-full-width/?sort_by=price-descending">Price, high to low</a></li>
                                                <li class="sort title-ascending"><a href="/collections/shop-6-col-full-width/?sort_by=title-ascending">Alphabetically, A-Z</a></li>
                                                <li class="sort title-descending"><a href="/collections/shop-6-col-full-width/?sort_by=title-descending">Alphabetically, Z-A</a>
                                                </li>
                                                <li class="sort created-ascending"><a href="/collections/shop-6-col-full-width/?sort_by=created-ascending">Date, old to new</a></li>
                                                <li class="sort created-descending"><a href="/collections/shop-6-col-full-width/?sort_by=created-descending">Date, new to old</a>
                                                </li>
                                                <li class="sort best-selling"><a href="/collections/shop-6-col-full-width/?sort_by=best-selling">Best Selling</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="collection-title-counter">
                            <h1 class="collection-title">Shop 6 col full width</h1>
                        ...
                        <div class="collection-items clearfix">
                            <div class="products">
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/whitewash-wood-ladder-decor-6" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/whitewash-wood-ladder-decor-6">Whitewash Wood
                                                                Ladder Decor</a>
                                                        </div>
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/wood-barn-door-storage-3" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/wood-barn-door-storage-3">Wood Barn Door
                                                                Storage</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/terracotta-pizza-oven-2" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/terracotta-pizza-oven-2">Terracotta Pizza
                                                                Oven</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/whitewash-wood-ladder-decor-5" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/whitewash-wood-ladder-decor-5">Whitewash Wood
                                                                Ladder Decor</a>
                                                        </div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/wood-barn-door-storage-2" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/wood-barn-door-storage-2">Wood Barn Door
                                                                Storage</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/hand-painted-tea-canisters-with-cork-lids-set-of-6" class="hoverBorder container_item">
                                                ...
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5"
                                                                href="/collections/shop-6-col-full-width/products/hand-painted-tea-canisters-with-cork-lids-set-of-6">Hand Painted
                                                                Tea Canisters With Cork Lids Set Of</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/tribal-drum-table-lamp-shade-2" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/tribal-drum-table-lamp-shade-2">Tribal Drum
                                                                Table Lamp Shade</a>
                                                        </div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/copper-tapered-3-tier-tiffin-lunch-boxes-set-of-3" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5"
                                                                href="/collections/shop-6-col-full-width/products/copper-tapered-3-tier-tiffin-lunch-boxes-set-of-3">Copper Tapered
                                                                3 Tier Tiffin Lunch Boxes Set Of</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/hand-painted-tea-canisters-with-cork-lids-set-of-5" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5"
                                                                href="/collections/shop-6-col-full-width/products/hand-painted-tea-canisters-with-cork-lids-set-of-5">Hand Painted
                                                                Tea Canisters With Cork Lids Set Of</a></div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/tribal-drum-table-lamp-shade-1" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/tribal-drum-table-lamp-shade-1">Tribal Drum
                                                                Table Lamp Shade</a>
                                                        </div>
                                                        <div class="rating-star">
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/copper-and-rope-3-tier-hanging-basket" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/copper-and-rope-3-tier-hanging-basket">Copper
                                                                And Rope 3-Tier
                                ...
                                <div class="product-item col-sm-2 ">
                                    <div class="product">
                                        <div class="row-left">
                                            <a href="/collections/shop-6-col-full-width/products/bird-on-newsprint-tea-tin-set-of-4" class="hoverBorder container_item">
                                        ...
                                        <div class="row-right animMix">
                                            <div class="grid-mode">
                                                <div class="product-title-price">
                                                    <div class="group">
                                                        <div class="product-title"><a class="title-5" href="/collections/shop-6-col-full-width/products/bird-on-newsprint-tea-tin-set-of-4">Bird On
                        ...
                        <div class="product-pagination">
                            <div class="pagination_group">
                                <ul class="pagination pagination-collection">
                                    ...
                                    <li><a href="/collections/shop-6-col-full-width?page=3&sort_by=manual">3</a></li>
                                    <li><a href="/collections/shop-6-col-full-width?page=4&sort_by=manual">4</a></li>
                                    <li class="next"><a href="/collections/shop-6-col-full-width?page=2&sort_by=manual"><span>Next</span><i class="cs-icon icon-ios-arrow-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        /* Handle Grid - List */
                            function handleGridList(){
                                ...
                                $('#goList').on(clickEv, function(e){
                                    ...
                                    $('.collection-items .product-item').removeClass('col-sm-2');
                                ...
                                $('#goGrid').on(clickEv, function(e){
                                    ...
                                    $('.collection-items .product-item').addClass('col-sm-2');
